...
import { SafeAreaProvider } from 'react-native-safe-area-context';  // For dynamic insets
import { SocketProvider } from './contexts/SocketContext';  // Import SocketProvider for global socket
...
// Add CallScreen if not already (for voice/video)
import CallScreen from './screens/CallScreen';  // From previous responses
    ...
    <Tab.Navigator
      screenOptions={({ route }) => ({
        ...
        tabBarStyle: {
          ...
          shadowOpacity: 0.1,
          shadowRadius: 4,
          height: 100,  // Increased: Taller tab bar (60 was too tight; 70 + labels)
          paddingBottom: 60,  // Reduced top padding for balance
          paddingTop: 5,
...
// Main App - SocketProvider inside NavigationContainer (fixes useNavigation error)
export default function App() {
  return (
    <SafeAreaProvider>  {/* Enables useSafeAreaInsets() in screens */}
      <NavigationContainer>
          <Stack.Navigator 
