...
export default function ChatListScreen({ navigation }: { navigation: any }) {
  ...
  return (
    <View style={styles.container}>
        <View style={{  // Space between icon and text
  ...
  justifyContent:"space-between",
         ...
         <Image 
          ...
          style={{height: 60, width: 60, alignSelf: 'center'}}  // Fixed size for header
        />
        <View>
        <Text style={styles.title}>Seamless Chat</Text>
      <Text style={styles.title1}>Chats ({onlineUsers.size} Online )</Text>
      </View>
      </View>
      <FlatList
        data={users}
